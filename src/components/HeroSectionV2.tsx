...
/**
 * Design-system-v2 preview only — reworked to move away from generic
 * AI-template patterns rather than just recoloring HeroSection.tsx:
 * - no radial "glow orb" — the actual brand mark sits large and faint
 *   in the background instead of a generic blurred blob
 * - no floating stat card widget — stats sit inline, editorial
 * - eyebrow label swapped from uppercase-tracked-caps to a plain
 *   code-comment-style kicker, closer to the brand voice
 * - primary button is a solid rounded-lg with a directional arrow
 *   instead of the ubiquitous rounded-full pill; secondary is a plain
 *   underlined link, not a bordered pill
 * - one unified entrance animation instead of five staggered ones
 */
const HeroSectionV2 = () => {
  return (
